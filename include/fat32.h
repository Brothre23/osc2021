...
struct fat32_boot_sector
{
    ...
    unsigned short n_max_root_directory_entries_16; // 0x11-0x12
    ...
    unsigned int root_directory_start_cluster_number;   // 0x2C-0x2F
    unsigned short fs_info_sector_number;               // 0x30-0x31
    unsigned short boot_sector_bak_first_sector_number; // 0x32-0x33
    unsigned int reserved[3];                           // 0x34-0x3F
    unsigned char physical_drive_number;                // 0x40
...
struct fat32_dentry
{
    ...
    unsigned int ext_attribute;      // 0x16-0x19
...
{
    unsigned int fat_region_block_index;
    unsigned int n_fat;
    unsigned int sector_per_fat;
    unsigned int data_region_block_index;
